...
describe('ProtocolsConfigure', () => {
    ...
    describe('create()', () => {
        ...
        describe('protocol definition validations', () => {
            ...
            it('should reject protocol definitions with `role` actions that contain a read action(`read` || `query` || `subscribe`) but not all of the read actions', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                yield expect(withoutSubscribePromise).to.be.rejectedWith(DwnErrorCode.ProtocolsConfigureRoleReadActionMissing);
                ...
                yield expect(withoutQueryPromise).to.be.rejectedWith(DwnErrorCode.ProtocolsConfigureRoleReadActionMissing);
                // without 'read' action
                ...
                yield expect(withoutReadPromise).to.be.rejectedWith(DwnErrorCode.ProtocolsConfigureRoleReadActionMissing);
