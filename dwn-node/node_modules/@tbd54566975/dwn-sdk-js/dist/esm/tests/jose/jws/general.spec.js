...
describe('General JWS Sign/Verify', () => {
    ...
    it('should throw an error for invalid Ed25519 JWK', () => __awaiter(void 0, void 0, void 0, function* () {
        const invalidJwk = {
            kty: 'RSA',
            crv: 'Ed25519',
        ...
        try {
            yield ed25519.sign(content, invalidJwk);
            expect.fail('Expected an error to be thrown');
        }
        catch (error) {
            expect(error).to.be.instanceOf(DwnError);
            expect(error.code).to.equal(DwnErrorCode.Ed25519InvalidJwk);
            expect(error.message).to.include('invalid jwk. kty MUST be OKP. crv MUST be Ed25519');
        }
    }));
    it('should convert public key bytes to JWK', () => __awaiter(void 0, void 0, void 0, function* () {
        const { publicJwk } = yield ed25519.generateKeyPair();
        const publicKeyBytes = Encoder.base64UrlToBytes(publicJwk.x);
        const convertedJwk = yield ed25519.publicKeyToJwk(publicKeyBytes);
