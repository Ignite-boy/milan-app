...
const schema103 = { "type": "object", "additionalProperties": false, "properties": { "publication": { "enum": ["Required", "Prohibited"], "type": "string" } } };
const schema91 = { "oneOf": [{ "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-read-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-subscribe-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope" }] };
...
const schema96 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Protocols" }, "method": { "const": "Configure" }, "protocol": { "type": "string" } } };
const schema97 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Protocols" }, "method": { "const": "Query" }, "protocol": { "type": "string" } } };
const schema98 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Records" }, "method": { "const": "Read" }, "protocol": { "type": "string" }, "contextId": { "type": "string" }, "protocolPath": { "type": "string" } } };
const schema99 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Records" }, "method": { "const": "Delete" }, "protocol": { "type": "string" }, "contextId": { "type": "string" }, "protocolPath": { "type": "string" } } };
const schema100 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Records" }, "method": { "const": "Write" }, "protocol": { "type": "string" }, "contextId": { "type": "string" }, "protocolPath": { "type": "string" } } };
const schema101 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Records" }, "method": { "const": "Query" }, "protocol": { "type": "string" }, "contextId": { "type": "string" }, "protocolPath": { "type": "string" } } };
const schema102 = { "type": "object", "additionalProperties": false, "required": ["interface", "method"], "properties": { "interface": { "const": "Records" }, "method": { "const": "Subscribe" }, "protocol": { "type": "string" }, "contextId": { "type": "string" }, "protocolPath": { "type": "string" } } };
        ...
        if (errors === _errs26) {
            if (data && typeof data == "object" && !Array.isArray(data)) {
                ...
                if (((data.interface === undefined) && (missing3 = "interface")) || ((data.method === undefined) && (missing3 = "method"))) {
                    const err18 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/required", keyword: "required", params: { missingProperty: missing3 }, message: "must have required property '" + missing3 + "'" };
                    if (vErrors === null) {
                        vErrors = [err18];
                    }
                    else {
                    ...
                    for (const key3 in data) {
                        if (!(((key3 === "interface") || (key3 === "method")) || (key3 === "protocol"))) {
                            const err19 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key3 }, message: "must NOT have additional properties" };
                            if (vErrors === null) {
                                vErrors = [err19];
                            }
                            else {
                    ...
                    if (_errs28 === errors) {
                        if (data.interface !== undefined) {
                            ...
                            if ("Protocols" !== data.interface) {
                                const err20 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Protocols" }, message: "must be equal to constant" };
                                if (vErrors === null) {
                                    vErrors = [err20];
                                }
                                else {
                        ...
                        if (valid8) {
                            if (data.method !== undefined) {
                                ...
                                if ("Configure" !== data.method) {
                                    const err21 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/properties/method/const", keyword: "const", params: { allowedValue: "Configure" }, message: "must be equal to constant" };
                                    if (vErrors === null) {
                                        vErrors = [err21];
                                    }
                                    else {
                            ...
                            if (valid8) {
                                if (data.protocol !== undefined) {
                                    const _errs31 = errors;
                                    if (typeof data.protocol !== "string") {
                                        const err22 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                        if (vErrors === null) {
                                            vErrors = [err22];
                                        }
                                        else {
                ...
                const err23 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                if (vErrors === null) {
                    vErrors = [err23];
                }
                else {
            ...
            if (errors === _errs34) {
                if (data && typeof data == "object" && !Array.isArray(data)) {
                    ...
                    if (((data.interface === undefined) && (missing4 = "interface")) || ((data.method === undefined) && (missing4 = "method"))) {
                        const err24 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/required", keyword: "required", params: { missingProperty: missing4 }, message: "must have required property '" + missing4 + "'" };
                        if (vErrors === null) {
                            vErrors = [err24];
                        }
                        else {
                        ...
                        for (const key4 in data) {
                            if (!(((key4 === "interface") || (key4 === "method")) || (key4 === "protocol"))) {
                                const err25 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key4 }, message: "must NOT have additional properties" };
                                if (vErrors === null) {
                                    vErrors = [err25];
                                }
                                else {
                        ...
                        if (_errs36 === errors) {
                            if (data.interface !== undefined) {
                                const _errs37 = errors;
                                if ("Protocols" !== data.interface) {
                                    const err26 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Protocols" }, message: "must be equal to constant" };
                                    if (vErrors === null) {
                                        vErrors = [err26];
                                    }
                                    else {
                            ...
                            if (valid10) {
                                if (data.method !== undefined) {
                                    const _errs38 = errors;
                                    if ("Query" !== data.method) {
                                        const err27 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/properties/method/const", keyword: "const", params: { allowedValue: "Query" }, message: "must be equal to constant" };
                                        if (vErrors === null) {
                                            vErrors = [err27];
                                        }
                                        else {
                                ...
                                if (valid10) {
                                    if (data.protocol !== undefined) {
                                        const _errs39 = errors;
                                        if (typeof data.protocol !== "string") {
                                            const err28 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                            if (vErrors === null) {
                                                vErrors = [err28];
                                            }
                                            else {
                    ...
                    const err29 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                    if (vErrors === null) {
                        vErrors = [err29];
                    }
                    else {
            ...
            if (_valid0 && valid0) {
                ...
                if (errors === _errs42) {
                    if (data && typeof data == "object" && !Array.isArray(data)) {
                        ...
                        if (((data.interface === undefined) && (missing5 = "interface")) || ((data.method === undefined) && (missing5 = "method"))) {
                            ...
                            for (const key5 in data) {
                                if (!(((((key5 === "interface") || (key5 === "method")) || (key5 === "protocol")) || (key5 === "contextId")) || (key5 === "protocolPath"))) {
                                    const err31 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key5 }, message: "must NOT have additional properties" };
                                    if (vErrors === null) {
                                        vErrors = [err31];
                                    }
                                    else {
                            ...
                            if (_errs44 === errors) {
                                if (data.interface !== undefined) {
                                    ...
                                    if ("Records" !== data.interface) {
                                        const err32 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Records" }, message: "must be equal to constant" };
                                        if (vErrors === null) {
                                            vErrors = [err32];
                                        }
                                        else {
                                ...
                                if (valid12) {
                                    if (data.method !== undefined) {
                                        const _errs46 = errors;
                                        if ("Read" !== data.method) {
                                            const err33 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/properties/method/const", keyword: "const", params: { allowedValue: "Read" }, message: "must be equal to constant" };
                                            if (vErrors === null) {
                                                vErrors = [err33];
                                            }
                                            else {
                                    ...
                                    if (valid12) {
                                        if (data.protocol !== undefined) {
                                            const _errs47 = errors;
                                            if (typeof data.protocol !== "string") {
                                                const err34 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                if (vErrors === null) {
                                                    vErrors = [err34];
                                                }
                                                else {
                                        ...
                                        if (valid12) {
                                            ...
                                            if (valid12) {
                                                if (data.protocolPath !== undefined) {
                                                    const _errs51 = errors;
                                                    if (typeof data.protocolPath !== "string") {
                                                        const err36 = { instancePath: instancePath + "/protocolPath", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err36];
                                                        }
                                                        else {
                        ...
                        const err37 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                        if (vErrors === null) {
                            vErrors = [err37];
                        }
                        else {
                    ...
                    if (errors === _errs54) {
                        if (data && typeof data == "object" && !Array.isArray(data)) {
                            ...
                            if (((data.interface === undefined) && (missing6 = "interface")) || ((data.method === undefined) && (missing6 = "method"))) {
                                const err38 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/required", keyword: "required", params: { missingProperty: missing6 }, message: "must have required property '" + missing6 + "'" };
                                if (vErrors === null) {
                                    vErrors = [err38];
                                }
                                else {
                                ...
                                for (const key6 in data) {
                                    if (!(((((key6 === "interface") || (key6 === "method")) || (key6 === "protocol")) || (key6 === "contextId")) || (key6 === "protocolPath"))) {
                                        const err39 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key6 }, message: "must NOT have additional properties" };
                                        if (vErrors === null) {
                                            vErrors = [err39];
                                        }
                                        else {
                                ...
                                if (_errs56 === errors) {
                                    if (data.interface !== undefined) {
                                        const _errs57 = errors;
                                        if ("Records" !== data.interface) {
                                            const err40 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Records" }, message: "must be equal to constant" };
                                            if (vErrors === null) {
                                                vErrors = [err40];
                                            }
                                            else {
                                    ...
                                    if (valid14) {
                                        if (data.method !== undefined) {
                                            ...
                                            if ("Delete" !== data.method) {
                                                const err41 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/properties/method/const", keyword: "const", params: { allowedValue: "Delete" }, message: "must be equal to constant" };
                                                if (vErrors === null) {
                                                    vErrors = [err41];
                                                }
                                                else {
                                        ...
                                        if (valid14) {
                                            if (data.protocol !== undefined) {
                                                const _errs59 = errors;
                                                if (typeof data.protocol !== "string") {
                                                    const err42 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                    if (vErrors === null) {
                                                        vErrors = [err42];
                                                    }
                                                    else {
                                            ...
                                            if (valid14) {
                                                if (data.contextId !== undefined) {
                                                    const _errs61 = errors;
                                                    if (typeof data.contextId !== "string") {
                                                        const err43 = { instancePath: instancePath + "/contextId", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/properties/contextId/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err43];
                                                        }
                                                        else {
                                                ...
                                                if (valid14) {
                                                    if (data.protocolPath !== undefined) {
                                                        const _errs63 = errors;
                                                        if (typeof data.protocolPath !== "string") {
                                                            const err44 = { instancePath: instancePath + "/protocolPath", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                            if (vErrors === null) {
                                                                vErrors = [err44];
                                                            }
                                                            else {
                            ...
                            const err45 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                            if (vErrors === null) {
                                vErrors = [err45];
                            }
                            else {
                        ...
                        if (errors === _errs66) {
                            if (data && typeof data == "object" && !Array.isArray(data)) {
                                ...
                                if (((data.interface === undefined) && (missing7 = "interface")) || ((data.method === undefined) && (missing7 = "method"))) {
                                    const err46 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/required", keyword: "required", params: { missingProperty: missing7 }, message: "must have required property '" + missing7 + "'" };
                                    if (vErrors === null) {
                                        vErrors = [err46];
                                    }
                                    else {
                                    ...
                                    for (const key7 in data) {
                                        if (!(((((key7 === "interface") || (key7 === "method")) || (key7 === "protocol")) || (key7 === "contextId")) || (key7 === "protocolPath"))) {
                                            const err47 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key7 }, message: "must NOT have additional properties" };
                                            if (vErrors === null) {
                                                vErrors = [err47];
                                            }
                                            else {
                                    ...
                                    if (_errs68 === errors) {
                                        if (data.interface !== undefined) {
                                            const _errs69 = errors;
                                            if ("Records" !== data.interface) {
                                                const err48 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Records" }, message: "must be equal to constant" };
                                                if (vErrors === null) {
                                                    vErrors = [err48];
                                                }
                                                else {
                                        ...
                                        if (valid16) {
                                            if (data.method !== undefined) {
                                                ...
                                                if ("Write" !== data.method) {
                                                    const err49 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/properties/method/const", keyword: "const", params: { allowedValue: "Write" }, message: "must be equal to constant" };
                                                    if (vErrors === null) {
                                                        vErrors = [err49];
                                                    }
                                                    else {
                                            ...
                                            if (valid16) {
                                                if (data.protocol !== undefined) {
                                                    const _errs71 = errors;
                                                    if (typeof data.protocol !== "string") {
                                                        const err50 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                        if (vErrors === null) {
                                                            vErrors = [err50];
                                                        }
                                                        else {
                                                ...
                                                if (valid16) {
                                                    if (data.contextId !== undefined) {
                                                        const _errs73 = errors;
                                                        if (typeof data.contextId !== "string") {
                                                            const err51 = { instancePath: instancePath + "/contextId", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/properties/contextId/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                            if (vErrors === null) {
                                                                vErrors = [err51];
                                                            }
                                                            else {
                                                    ...
                                                    if (valid16) {
                                                        if (data.protocolPath !== undefined) {
                                                            const _errs75 = errors;
                                                            if (typeof data.protocolPath !== "string") {
                                                                const err52 = { instancePath: instancePath + "/protocolPath", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err52];
                                                                }
                                                                else {
                                ...
                                const err53 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                                if (vErrors === null) {
                                    vErrors = [err53];
                                }
                                else {
                            ...
                            if (errors === _errs78) {
                                if (data && typeof data == "object" && !Array.isArray(data)) {
                                    ...
                                    if (((data.interface === undefined) && (missing8 = "interface")) || ((data.method === undefined) && (missing8 = "method"))) {
                                        const err54 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/required", keyword: "required", params: { missingProperty: missing8 }, message: "must have required property '" + missing8 + "'" };
                                        if (vErrors === null) {
                                            vErrors = [err54];
                                        }
                                        else {
                                        ...
                                        for (const key8 in data) {
                                            if (!(((((key8 === "interface") || (key8 === "method")) || (key8 === "protocol")) || (key8 === "contextId")) || (key8 === "protocolPath"))) {
                                                const err55 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key8 }, message: "must NOT have additional properties" };
                                                if (vErrors === null) {
                                                    vErrors = [err55];
                                                }
                                                else {
                                        ...
                                        if (_errs80 === errors) {
                                            if (data.interface !== undefined) {
                                                const _errs81 = errors;
                                                if ("Records" !== data.interface) {
                                                    const err56 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Records" }, message: "must be equal to constant" };
                                                    if (vErrors === null) {
                                                        vErrors = [err56];
                                                    }
                                                    else {
                                            ...
                                            if (valid18) {
                                                if (data.method !== undefined) {
                                                    const _errs82 = errors;
                                                    if ("Query" !== data.method) {
                                                        const err57 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/properties/method/const", keyword: "const", params: { allowedValue: "Query" }, message: "must be equal to constant" };
                                                        if (vErrors === null) {
                                                            vErrors = [err57];
                                                        }
                                                        else {
                                                ...
                                                if (valid18) {
                                                    if (data.protocol !== undefined) {
                                                        const _errs83 = errors;
                                                        if (typeof data.protocol !== "string") {
                                                            const err58 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                            if (vErrors === null) {
                                                                vErrors = [err58];
                                                            }
                                                            else {
                                                    ...
                                                    if (valid18) {
                                                        if (data.contextId !== undefined) {
                                                            const _errs85 = errors;
                                                            if (typeof data.contextId !== "string") {
                                                                const err59 = { instancePath: instancePath + "/contextId", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/properties/contextId/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err59];
                                                                }
                                                                else {
                                                        ...
                                                        if (valid18) {
                                                            if (data.protocolPath !== undefined) {
                                                                const _errs87 = errors;
                                                                if (typeof data.protocolPath !== "string") {
                                                                    const err60 = { instancePath: instancePath + "/protocolPath", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                    if (vErrors === null) {
                                                                        vErrors = [err60];
                                                                    }
                                                                    else {
                                    ...
                                    const err61 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                                    if (vErrors === null) {
                                        vErrors = [err61];
                                    }
                                    else {
                                ...
                                if (errors === _errs90) {
                                    if (data && typeof data == "object" && !Array.isArray(data)) {
                                        ...
                                        if (((data.interface === undefined) && (missing9 = "interface")) || ((data.method === undefined) && (missing9 = "method"))) {
                                            const err62 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/required", keyword: "required", params: { missingProperty: missing9 }, message: "must have required property '" + missing9 + "'" };
                                            if (vErrors === null) {
                                                vErrors = [err62];
                                            }
                                            else {
                                            ...
                                            for (const key9 in data) {
                                                if (!(((((key9 === "interface") || (key9 === "method")) || (key9 === "protocol")) || (key9 === "contextId")) || (key9 === "protocolPath"))) {
                                                    const err63 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/additionalProperties", keyword: "additionalProperties", params: { additionalProperty: key9 }, message: "must NOT have additional properties" };
                                                    if (vErrors === null) {
                                                        vErrors = [err63];
                                                    }
                                                    else {
                                            ...
                                            if (_errs92 === errors) {
                                                if (data.interface !== undefined) {
                                                    const _errs93 = errors;
                                                    if ("Records" !== data.interface) {
                                                        const err64 = { instancePath: instancePath + "/interface", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/properties/interface/const", keyword: "const", params: { allowedValue: "Records" }, message: "must be equal to constant" };
                                                        if (vErrors === null) {
                                                            vErrors = [err64];
                                                        }
                                                        else {
                                                ...
                                                if (valid20) {
                                                    if (data.method !== undefined) {
                                                        const _errs94 = errors;
                                                        if ("Subscribe" !== data.method) {
                                                            const err65 = { instancePath: instancePath + "/method", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/properties/method/const", keyword: "const", params: { allowedValue: "Subscribe" }, message: "must be equal to constant" };
                                                            if (vErrors === null) {
                                                                vErrors = [err65];
                                                            }
                                                            else {
                                                    ...
                                                    if (valid20) {
                                                        if (data.protocol !== undefined) {
                                                            const _errs95 = errors;
                                                            if (typeof data.protocol !== "string") {
                                                                const err66 = { instancePath: instancePath + "/protocol", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/properties/protocol/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                if (vErrors === null) {
                                                                    vErrors = [err66];
                                                                }
                                                                else {
                                                        ...
                                                        if (valid20) {
                                                            if (data.contextId !== undefined) {
                                                                const _errs97 = errors;
                                                                if (typeof data.contextId !== "string") {
                                                                    const err67 = { instancePath: instancePath + "/contextId", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/properties/contextId/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                    if (vErrors === null) {
                                                                        vErrors = [err67];
                                                                    }
                                                                    else {
                                                            ...
                                                            if (valid20) {
                                                                if (data.protocolPath !== undefined) {
                                                                    const _errs99 = errors;
                                                                    if (typeof data.protocolPath !== "string") {
                                                                        const err68 = { instancePath: instancePath + "/protocolPath", schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/properties/protocolPath/type", keyword: "type", params: { type: "string" }, message: "must be string" };
                                                                        if (vErrors === null) {
                                                                            vErrors = [err68];
                                                                        }
                                                                        else {
                                        ...
                                        const err69 = { instancePath, schemaPath: "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope/type", keyword: "type", params: { type: "object" }, message: "must be object" };
                                        if (vErrors === null) {
                                            vErrors = [err69];
                                        }
                                        else {
...
const schema104 = { "$schema": "https://json-schema.org/draft/2020-12/schema", "$id": "https://identity.foundation/dwn/json-schemas/permission-request-data.json", "type": "object", "additionalProperties": false, "required": ["delegated", "scope"], "properties": { "description": { "type": "string" }, "delegated": { "type": "boolean" }, "scope": { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/defs.json#/$defs/scope" }, "conditions": { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/defs.json#/$defs/conditions" } } };
...
const schema90 = { "$schema": "https://json-schema.org/draft/2020-12/schema", "$id": "https://identity.foundation/dwn/json-schemas/permissions/defs.json", "type": "object", "$defs": { "scope": { "oneOf": [{ "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-read-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/messages-subscribe-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-configure-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/protocols-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-read-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-delete-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-write-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-query-scope" }, { "$ref": "https://identity.foundation/dwn/json-schemas/permissions/scopes.json#/$defs/records-subscribe-scope" }] }, "conditions": { "type": "object", "additionalProperties": false, "properties": { "publication": { "enum": ["Required", "Prohibited"], "type": "string" } } } } };
                                                            ...
                                                            if (data10.length < 1) {
                                                                ...
                                                                for (let i2 = 0; i2 < len2; i2++) {
                                                                    ...
                                                                    if (!((((((((data11 === "co-delete") || (data11 === "co-update")) || (data11 === "create")) || (data11 === "delete")) || (data11 === "query")) || (data11 === "subscribe")) || (data11 === "read")) || (data11 === "update"))) {
                                                                        const err13 = { instancePath: instancePath + "/$actions/" + i0 + "/can/" + i2, schemaPath: "#/properties/%24actions/items/oneOf/1/properties/can/items/enum", keyword: "enum", params: { allowedValues: schema119.properties.$actions.items.oneOf[1].properties.can.items.enum }, message: "must be equal to one of the allowed values" };
                                                                        if (vErrors === null) {
                                                                            vErrors = [err13];
                                                                        }
                                                                        else {
                                ...
                                if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.messageTimestamp === undefined) && (missing1 = "messageTimestamp"))) || ((data1.definition === undefined) && (missing1 = "definition"))) {
                                    ...
                                    if (_errs5 === errors) {
                                        if (data1.interface !== undefined) {
                                            ...
                                            if (!(data2 === "Protocols")) {
                                                validate76.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema120.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                return false;
                                            }
                                            var valid1 = _errs6 === errors;
                                        }
                                        ...
                                        if (valid1) {
                                            if (data1.method !== undefined) {
                                                ...
                                                if (!(data3 === "Configure")) {
                                                    validate76.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema120.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs8 === errors;
                                            }
                                ...
                                if ((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.messageTimestamp === undefined) && (missing1 = "messageTimestamp"))) {
                                    ...
                                    if (_errs5 === errors) {
                                        if (data1.interface !== undefined) {
                                            ...
                                            if (!(data2 === "Protocols")) {
                                                validate79.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema122.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                return false;
                                            }
                                            var valid1 = _errs6 === errors;
                                        }
                                        ...
                                        if (valid1) {
                                            if (data1.method !== undefined) {
                                                ...
                                                if (!(data3 === "Query")) {
                                                    validate79.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema122.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs8 === errors;
                                            }
                                ...
                                if (((((data1.interface === undefined) && (missing1 = "interface")) || ((data1.method === undefined) && (missing1 = "method"))) || ((data1.messageTimestamp === undefined) && (missing1 = "messageTimestamp"))) || ((data1.filter === undefined) && (missing1 = "filter"))) {
                                    ...
                                    if (_errs5 === errors) {
                                        if (data1.interface !== undefined) {
                                            ...
                                            if (!(data2 === "Records")) {
                                                validate81.errors = [{ instancePath: instancePath + "/descriptor/interface", schemaPath: "#/properties/descriptor/properties/interface/enum", keyword: "enum", params: { allowedValues: schema125.properties.descriptor.properties.interface.enum }, message: "must be equal to one of the allowed values" }];
                                                return false;
                                            }
                                            var valid1 = _errs6 === errors;
                                        }
                                        ...
                                        if (valid1) {
                                            if (data1.method !== undefined) {
                                                ...
                                                if (!(data3 === "Read")) {
                                                    validate81.errors = [{ instancePath: instancePath + "/descriptor/method", schemaPath: "#/properties/descriptor/properties/method/enum", keyword: "enum", params: { allowedValues: schema125.properties.descriptor.properties.method.enum }, message: "must be equal to one of the allowed values" }];
                                                    return false;
                                                }
                                                var valid1 = _errs8 === errors;
                                            }
