 ...
 */
export declare function raceSignal<T>(promise: T, signal?: AbortSignal | null, opts?: RaceSignalOptions): T;
export declare function raceSignal<T>(promise: Promise<T>, signal?: AbortSignal | null, opts?: RaceSignalOptions): Promise<T>;
