/*!
 * MILAN — Creative Mode 🎨
 * One-click full-UI theme switcher. 10 hand-tuned themes.
...
(function () {
  ...
  function themeCss(t) {
    ...
    return [
      ...
      // buttons (primary)
      S + ' button:not(.ghost):not(.soft):not(.mcm-btn):not(.tab),' + S + ' .login-button,' + S + ' #loginBtn,' + S + ' #registerBtn{background:' + grad + ' !important;color:' + t.btn + ' !important;border:0 !important;box-shadow:0 6px 20px ' + t.brand + '44 !important;}',
      // ghost/soft buttons
