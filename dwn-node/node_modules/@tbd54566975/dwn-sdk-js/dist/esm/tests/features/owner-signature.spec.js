...
export function testOwnerSignature() {
    describe('owner signature', () => __awaiter(this, void 0, void 0, function* () {
        ...
        it('should use `ownerSignature` for authorization when it is given - flat-space', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const ownerSignedMessage = yield RecordsWrite.parse(entry.recordsWrite);
            ...
            expect((_b = readReply2.entry.recordsWrite) === null || _b === void 0 ? void 0 : _b.descriptor).to.exist;
            const dataFetched = yield DataStream.toBytes(readReply2.entry.data);
        ...
        it('should use `ownerSignature` for authorization when it is given - protocol-space', () => __awaiter(this, void 0, void 0, function* () {
            ...
            expect(readReply.status.code).to.equal(200);
            expect(readReply.entry.recordsWrite).to.exist;
            expect((_c = readReply.entry.recordsWrite) === null || _c === void 0 ? void 0 : _c.descriptor).to.exist;
