...
export function testEndToEndScenarios() {
    describe('End-to-end Scenarios Spanning Features', () => {
        ...
        it('should support a multi-participant encrypted chat protocol', () => __awaiter(this, void 0, void 0, function* () {
            ...
            const encryptedContextDerivedPrivateKeyBytes = yield DataStream.toBytes(participantReadReply.entry.data); // to create streams for testing
            ...
            const decryptedContextDerivedKeyStream = yield Records.decrypt(participantRecordWriteFetched, bobProtocolPathDerivedPrivateKey, DataStream.fromBytes(encryptedContextDerivedPrivateKeyBytes));
            ...
            const decryptedContextDerivedKeyStream2 = yield Records.decrypt(participantRecordWriteFetched, bobRootKey, DataStream.fromBytes(encryptedContextDerivedPrivateKeyBytes));
            ...
            const decryptedChatThread = yield Records.decrypt(threadReadReply.entry.recordsWrite, decryptedContextDerivedPrivateKey, threadReadReply.entry.data);
            ...
            const encryptedChatMessageBytes = yield DataStream.toBytes(chatReadReply.entry.data); // to create streams for testing
            const decryptedChatMessage = yield Records.decrypt(chatReadReply.entry.recordsWrite, decryptedContextDerivedPrivateKey, DataStream.fromBytes(encryptedChatMessageBytes));
            ...
            const decryptedChatMessageStream2 = yield Records.decrypt(chatReadReply.entry.recordsWrite, aliceRootKey, DataStream.fromBytes(encryptedChatMessageBytes));
