...
export class ProtocolsConfigureHandler {
    ...
    handle({ tenant, message, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield ProtocolsConfigureHandler.authorizeProtocolsConfigure(tenant, protocolsConfigure, this.messageStore);
            }
            catch (e) {
    ...
    static authorizeProtocolsConfigure(tenant, protocolConfigure, messageStore) {
        return __awaiter(this, void 0, void 0, function* () {
            if (protocolConfigure.isSignedByAuthorDelegate) {
                yield protocolConfigure.authorizeAuthorDelegate(messageStore);
            }
            if (protocolConfigure.author === tenant) {
                ...
                const permissionGrant = yield PermissionsProtocol.fetchGrant(tenant, messageStore, protocolConfigure.signaturePayload.permissionGrantId);
